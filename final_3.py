...
# supervised learning classification model alogrition 
# The Classification algorithm is a Supervised Learning technique that is used to identify the category of new observations on the basis of training data.
# there are different classificion cnn,knn alogrithem 
# data set lia on kaggel by using thesee pictures i trained cnn model
# after cnn is the closest neighbour algorithem
# it is classfiing iamg to 5
# we have total 5 classfication 1,2,3,4,5
# matrix for this for 
# cretain level of confidence for outpit by backprogation weight ko ressign 